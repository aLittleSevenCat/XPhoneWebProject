...
var getByClass = function (className) {
  ...
  window.onload = function  (argument) {
    ...
    addClass( getByClass('screen-2__point_i_2')[0],'screen-2__point_i_2_animate_init');
    addClass( getByClass('screen-2__point_i_3')[0],'screen-2__point_i_3_animate_init');
    addClass( getByClass('screen-2__point_i_1')[0],'screen-2__point_i_1_animate_init');
  ...
  window.onscroll = function () {
    ...
    if(top>1*800-61){
      ...
      removeClass( getByClass('screen-2__point')[0],'screen-2__point_i_2_animate_init');
      removeClass( getByClass('screen-2__point')[0],'screen-2__point_i_3_animate_init');
      removeClass( getByClass('screen-2__point_i_1')[0],'screen-2__point_i_1_animate_init');
      ...
      addClass( getByClass('screen-2__point_i_1')[0],'screen-2__point_i_1_animate_done');
      addClass( getByClass('screen-2__point_i_2')[0],'screen-2__point_i_2_animate_done');
      addClass( getByClass('screen-2__point_i_3')[0],'screen-2__point_i_3_animate_done');
